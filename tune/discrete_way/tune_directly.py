...
from ray.rllib.agents import a3c, pg, ddpg
...
if __name__ == '__main__':
    ...
    trainer = ddpg.DDPGTrainer(config=config, env='DiscreteEnv-v1')
    ...
    for i in tqdm.trange(1000):
        ...
        if i % 50 == 0:
            rollout.rollout(trainer, env_name='DiscreteEnv-v1', num_steps=env_config.max_step, num_episodes=3,
                            no_render=False)
