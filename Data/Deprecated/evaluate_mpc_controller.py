...
from Controllers.mpc_model import make_reward_fn, ShootingMPCController
...
if __name__ == '__main__':
    ...
    # mpc_controller = CemMPCController(cfg_vae, env.action_space, dynamics, repr_model, action_encoder,
    ...
    for i in range(100):
        ...
        plt.imshow(np.concatenate([env.canvas.frames, env.target_image], axis=1))
